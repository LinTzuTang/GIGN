...
def generate_pocket(data_dir, distance=5):
    ...
    for cid in complex_id:
        ...
        lig_native_path = os.path.join(complex_dir, f"{cid}_*.mol2")
...
if __name__ == '__main__':
    ...
    data_dir = os.path.join(data_root, 'pdbbind_rna_set')
    data_df = pd.read_csv(os.path.join(data_root, 'pdbbind_NL_labels_rna.csv'))
